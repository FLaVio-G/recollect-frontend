...
export function RedefinirSenhaCard() {
    return (
        <Card align='center' className="redefinir-senha-card" backdropFilter='auto' backdropBlur='40px' ml='2%' mr='2%' border='1px' borderStartRadius='20px' borderEndRadius='20px' variant='outline'>
